...
public class CricketScoreCardWebTable 
{
	...
	public static void main(String[] args)
	{
		...
		driver.get("https://www.espncricinfo.com/series/8048/scorecard/1216496/rajasthan-royals-vs-chennai-super-kings-4th-match-indian-premier-league-2020-21");
		// a[contains(text(),'TK Curran')]//parent::td//following-sibling::td/span
		//String wicketTaker = driver.findElement(By.xpath("//a[contains(text(),'SPD Smith')]//parent::td//following-sibling::td//span//span")).getText();
