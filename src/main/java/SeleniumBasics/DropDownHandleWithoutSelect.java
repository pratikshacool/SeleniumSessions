...
public class DropDownHandleWithoutSelect 
{
	...
	public static void main(String[] args)
	{
		...
		selectDropDownValueWithoutSelectClass(country_options, "Singapore");
		
  //	List<WebElement> industry_options_list = driver.findElements(By.xpath("//select[@id='Form_submitForm_Industry']/option"));
//		
